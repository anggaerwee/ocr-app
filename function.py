...
def parse_row(row_text):
    try:
        ...
        description = description.replace("IGRASS", "GRASS").replace("sMIDE", "615MM").replace("S0", "90").replace("LYS", "LVS").replace("404", "40#").replace("4xe", "4x4").replace("(Green", "Green").replace("sCWvLettuce", "Lettuce")
